...
class AnalyzeContext {
	...
	private static final Logger logger = ESPluginLoggerFactory.getLogger(AnalyzeContext.class.getName());
	//默认缓冲区大小
		...
		for( ; index <= this.cursor ;){
			...
			if(path != null){
				...
				while(l != null){
					...
					//l.setLexemeText(UnicodeUtils.encryptStr(l.getLexemeText()));
					this.results.add(l);
